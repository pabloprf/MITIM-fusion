...
def normalizations_profiles(profiles):
    ...
    if profiles is not None:
        Set_norm = {
            ...
            "exp_Qe": profiles.derived["qe_MWmiller"] / profiles.derived["surfGACODE_miller"],  # This is the same as qe_MWm2
            "exp_Qi": profiles.derived["qi_MWmiller"] / profiles.derived["surfGACODE_miller"],
            "exp_Ge": profiles.derived["ge_10E20miller"] / profiles.derived["surfGACODE_miller"],
