...
'''
    ...
    def to_transp(self, folder = '~/scratch/', shot = '12345', runid = 'P01', times = [0.0,1.0], Vsurf = 0.0, mxh_coeffs_smooth = 5, rotation_source = 'echo', write_rotation = '__unset__', boundary_surface_psin = 1.0, boundary_override = None):
        ...
        if setup_rotation:
            ...
            # neoclassical_transp: ship the omg U-File as ZEROS (weak-rotation input), ignoring any seed w0
            transp.omg_zeroed = (rotation_source == 'neoclassical_transp')
