...
def tglf_scan_trick(fluxesTGYRO, tgyro, label, RadiisToRun, profiles, impurityPosition=1, includeFast=False,  delta=0.02, cold_start=False, check_coincidence_thr=1E-2, extra_name="", remove_folders_out = False):
