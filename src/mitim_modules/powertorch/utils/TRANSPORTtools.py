...
class power_transport:
    ...
    def _produce_profiles(self,derive_quantities=True):
        ...
        self.applyCorrections = self.powerstate.transport_options["ModelOptions"].get("MODELparameters", {}).get("applyCorrections", {})
    ...
    def _modify_profiles(self):
        ...
        profiles_postprocessing_fun = self.powerstate.transport_options["ModelOptions"].get("profiles_postprocessing_fun", None)
